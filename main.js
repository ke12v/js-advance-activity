...
function iterateNumbers() {
    ...
    if (numbersArr.length > 0) {
        ...
        numbersArr.forEach((num, i) => {
            ...
            const btnDelete = createButton("Remove", () => deleteNumber(i));
            const btnEdit = createButton("Edit", () => editNumber(i));
        ...
        btn3.style.display = "inline"; // Show "Clear Items" button
...
btnHighLow.addEventListener("click", () => {
    if (numbersArr.length > 0) {
        ...
        tdHighestValue.innerHTML = highest; // Corrected format
        ...
        tdLowestValue.innerHTML = lowest; // Corrected format
